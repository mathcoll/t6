...
secret				= "hhhththt"; // Keyboard-cat
sessionDuration		= 3600*24*10; // 10 days cookie session
store				= new FileStore({ttl: sessionDuration, path: 'C:/Users/mlory/Documents/GitHub/t6/sessions/'}); // Force session folder as absolute path in settings
...
jwtsettings = {
	...
	secret: "jtrjtrjtrjtr" // Keyboard-cat
};
...
logAccessFile		= "C:/Users/mlory/Documents/GitHub/t6/sessions/t6-access.log";
logErrorFile		= "C:/Users/mlory/Documents/GitHub/t6/sessions/6-error.log";
...
transporter = nodemailer.createTransport({
	...
	dkim : {
		domainName : "",
		keySelector : "",
		privateKey : fs.readFileSync("C:/Users/mlory/Documents/GitHub/t6/data/certificates/dkim/privatekey.txt", "utf8")
	}
});
