...
function ModelSerializer(model) {
	this.serialize = function() {
		return new JSONAPISerializer("model", {
			...
			attributes : [ "name", "datasets", "flow_ids", "validation_split", "batch_size", "epochs", "continuous_features", "categorical_features", "history", "current_status", "labels", "min", "max", "retention" ],
			topLevelLinks : {
