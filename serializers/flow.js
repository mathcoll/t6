...
function FlowSerializer(flow) {
	this.serialize = function() {
		return new JSONAPISerializer("flow", {
			...
			attributes : [ "name", "unit", "objects", "require_signed", "require_encrypted", "dead_notification", "dead_notification_interval", "permission", "data_type", "mqtt_topic", "track_id", "fusion_algorithm", "ttl", "preprocessor", "influx_db_cloud", "retention", "user_id", "meta" ],
			topLevelLinks : {
