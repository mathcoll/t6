...
function UserSerializer(user) {
	this.serialize = function () {
		return new JSONAPISerializer("user", {
			...
			attributes: ["firstName", "lastName", "login", "email", "role", "iftttCode", "iftttTrigger_identity", "pushSubscription", "location", "unsubscription", "unsubscription_token", "passwordLastUpdated", "reminderMail", "changePasswordMail", "subscription_date", "update_date", "permissions", "gravatar"],
			topLevelLinks : {
