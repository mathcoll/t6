...
function UserSerializer(user) {
  this.serialize = function () {
    return new JSONAPISerializer('user', {
    	...
    	attributes: ['firstName', 'lastName', 'login', 'email', 'role', 'location', 'passwordLastUpdated', 'reminderMail', 'changePasswordMail', 'subscription_date', 'update_date', 'permissions', 'gravatar'],
		topLevelLinks : {
