...
### Security
* Make an HTTP POST request to a endpoint (http://127.0.0.1:3000/users/me/token) with your own private API_KEY and API_SECRET, which validates the user's API key pair
